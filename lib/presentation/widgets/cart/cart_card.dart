...
class CartCard extends StatelessWidget {
                    ...
                    Card(
                      ...
                      child: ClipRRect(
                          ...
                          child: Image.network(
                            ...
                            width: SizeConfig.setWidgetWidth(100, 133, 133),
                            height: SizeConfig.setWidgetHeight(100, 133, 133),
                            fit: BoxFit.cover,
                          )),
                    ),
                    Expanded(
  ...
  Future<void> delete(BuildContext context, CartProvider cartProvider) async {
    ...
    final bool status = await cartProvider.deleteCartItem(
      context: context,
  ...
  Future<void> update(
    ...
    final bool status = await cartProvider.updateCartItem(
      context: context,
      productId: item.id.toString(),
      quantity: quantity,
    );
