                        ...
                        Container(
                          ...
                          child: Form(
                            child: TextFormField(
                              ...
                              enabled: !cartProvider.promoIsActive,
                              ...
                              style: Theme.of(context).textTheme.displayMedium!
                                  .copyWith(
                                    fontSize: 16,
                                    fontWeight: cartProvider.promoIsActive
                                        ? FontWeight.bold
                                        : FontWeight.normal,
                                  ),
                        ...
                        InkWell(
                          onTap: () async {
                            if (cartProvider
                                ...
                                .text
                                .isNotEmpty) {
                              if (cartProvider.promoIsActive) {
                                cartProvider.removePromoCode();
                              } else {
                                bool status = await cartProvider.checkCoupon(
                                  context: context,
                                );
                                if (context.mounted) {
                                  Navigator.of(
