...
class GiftCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MainCard(
      padding: const EdgeInsets.only(bottom: 30, right: 10, left: 10, top: 20),
      height: 200,
      child: Container(
            ...
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    AppLocalizations.of(context)!.tr('gift_card'),
                ...
                Padding(
                  ...
                  child: Image.asset(FixedAssets.logo, width: 60, height: 100),
                ),
              ],
            ),
            Row(
