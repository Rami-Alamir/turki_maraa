    ...
    return Consumer<AppProvider>(builder: (_, appProvider, __) {
      return ListView(
        ...
        children: [
          ...
          if (appProvider.adhaConfig?.categoryId ==
              productProvider
          ...
          Visibility(
            visible:
                productProvider.productData[widget.index].data!.sizes!.length >
                    1,
            child: ExtrasList(
          ...
          ExtrasList(
            ...
            isVisible: productProvider.selectedDay != -1
                ? (appProvider.adhaConfig?.cutStatus?[
