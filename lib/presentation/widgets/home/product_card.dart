...
class ProductCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
        padding: EdgeInsets.all(isLarge ? 5 : 0),
        child: Container(
          ...
          child: InkWell(
            onTap: () {
              FirebaseHelper()
                  .pushAnalyticsEvent(name: "product", value: nameEn);
            ...
            child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    padding:
                        const EdgeInsets.only(top: 5, left: 7.5, right: 7.5),
                    child: Container(
                  ...
                  Padding(
                      padding:
                          const EdgeInsets.only(top: 3, left: 7.5, right: 7.5),
                      child: Row(
                        children: [
                          Padding(
                            padding: const EdgeInsets.only(
