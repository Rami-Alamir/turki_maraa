...
class ProductsList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PrimaryAppBar(title: data['title'], back: true),
      body: ListView(
        children: [
          Padding(
                          ...
                          Padding(
                            ...
                            child: ProductCard(
                              ...
                              id: productsProvider
                                  ...
                                  .products![i]
                                  .id!,
                              categoryId: productsProvider
                                  .productsList
                                  .data![data['index']]
                                  .products![i]
                                  .categoryId!,
                              nameAr: productsProvider
                                  .productsList
                                  .data![data['index']]
                                  .products![i]
                                  .nameAr!,
                              nameEn: productsProvider
                                  .productsList
                                  .data![data['index']]
                                  .products![i]
                                  .nameEn!,
                              ...
                              price: productsProvider
                                  .productsList
                                  .data![data['index']]
                                  .products![i]
                                  .price!,
                              salePrice: productsProvider
                                  .productsList
                                  .data![data['index']]
                                  .products![i]
                                  .salePrice!,
                              tag: (productsProvider
                                  .productsList
                                  .data![data['index']]
                                  .products?[i]
                                  .tags),
