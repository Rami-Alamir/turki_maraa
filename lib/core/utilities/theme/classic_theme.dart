...
final ThemeData classicTheme = ThemeData(
  ...
  textTheme: const TextTheme(
    ...
    headlineMedium: TextStyle(
        color: AppColors.land, fontWeight: FontWeight.w500, fontSize: 20),
  ...
  colorScheme: ColorScheme.fromSwatch().copyWith(
      ...
      shadow: AppColors.authenticity.withOpacity(0.35),
      outline: AppColors.authenticity.withOpacity(0.35),
      primaryContainer: AppColors.clarity,
      secondaryContainer: AppColors.authenticity.withOpacity(0.5),
      tertiaryContainer: AppColors.authenticity,
      onBackground: AppColors.clarity,
      onTertiary: AppColors.authenticity,
      background: AppColors.clarity),
);
